...
class ToneStackFaust : public FaustImpl {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst19 = (2.0f * (1.0f - (1.0f / ToneStackFaust_faustpower2_f(fConst18))));
	...
	virtual ToneStackFaust* clone() {
		return new ToneStackFaust();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (1.0f - std::min<float>(std::max<float>(fSlow0, 0.0f), 1.0f));
		...
		float fSlow24 = (1.0f - std::min<float>(std::max<float>(std::fabs((fSlow0 + -1.0f)), 0.0f), 1.0f));
		float fSlow25 = (fConst13 * fSlow2);
		float fSlow26 = (0.0f - fSlow25);
		float fSlow27 = (484000000.0f * (ToneStackFaust_faustpower2_f(fSlow9) + (-0.504999995f - fSlow8)));
		float fSlow28 = ((0.200000003f * (fSlow5 * float((fSlow5 <= 0.5f)))) + (float((fSlow5 > 0.5f)) * ((1.60000002f * fSlow5) + -0.699999988f)));
		...
		float fSlow34 = ((fSlow27 + (22000.0f * ((1000000.0f * (0.0f - fSlow29)) + (33000.0f * (0.0f - (0.495000005f * (1.0f - fSlow7))))))) + (1000000.0f * (0.0f - (33000.0f * fSlow28))));
		...
		float fSlow46 = (std::min<float>(std::max<float>(fSlow0, 1.0f), 2.0f) + -1.0f);
		float fSlow47 = (fConst23 * ((250000.0f * ((100000.0f * fSlow2) + 10000.0f)) + 1e+09f));
		...
		float fSlow52 = (((150000.0f * ((250000.0f * fSlow51) + -10000.0f)) + (6.24999997e+10f * fSlow50)) + (250000.0f * ((250000.0f * (fSlow2 * fSlow51)) + -10000.0f)));
		float fSlow53 = (6250.0f * fSlow50);
		float fSlow54 = ((2.2e-08f * fSlow51) + -1.00000001e-07f);
		float fSlow55 = ((((150000.0f * ((fSlow53 + (4813.0f * fSlow51)) + -440.320007f)) + (6.24999997e+10f * (fSlow50 * ((0.0250000004f * fSlow2) + 0.0192520004f)))) + (250000.0f * ((250000.0f * (fSlow2 * ((((0.0121999998f * fSlow51) + (10000.0f * fSlow54)) + (0.0055999998f * fSlow51)) + (0.00123199995f * fSlow51)))) + -190.320007f))) + (2.5e+09f * ((100000.0f * (0.0f - (1.22000003e-07f * fSlow2))) - (0.00683199987f * fSlow2))));
		float fSlow56 = (((150000.0f * ((22.8250008f * fSlow50) - (0.85799998f * fSlow28))) + (6.24999997e+10f * (fSlow50 * ((9.12999967e-05f * fSlow2) + 3.43200009e-06f)))) - (214500.0f * (fSlow2 * fSlow28)));
		...
		float fSlow71 = (fConst29 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow69))));
		float fSlow72 = (iSlow70 ? fConst29 : fSlow71);
		float fSlow73 = (1.0f - (fConst28 * (fSlow72 - fConst28)));
		...
		float fSlow77 = (1.0f - (fConst28 * (fSlow75 - fConst28)));
		float fSlow78 = (10.0f * float(fEntry4));
		int iSlow79 = (fSlow78 > 0.0f);
		float fSlow80 = (fConst31 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow78))));
		float fSlow81 = (iSlow79 ? fConst31 : fSlow80);
		float fSlow82 = (1.0f - (fConst30 * (fSlow81 - fConst30)));
		...
		float fSlow86 = (1.0f - (fConst30 * (fSlow84 - fConst30)));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			float fTempFTZ0 = (fTemp0 - (fConst6 * ((fConst7 * fRec1[2]) + (276000.0f * fRec1[1]))));
			fRec1[0] = ((*reinterpret_cast<int*>(&fTempFTZ0) & 2139095040) ? fTempFTZ0 : 0.0f);
			float fTempFTZ1 = (fTemp0 - (fSlow17 * ((fSlow18 * fRec2[2]) + (fSlow19 * fRec2[1]))));
			fRec2[0] = ((*reinterpret_cast<int*>(&fTempFTZ1) & 2139095040) ? fTempFTZ1 : 0.0f);
			float fTempFTZ2 = (fTemp0 - (fConst14 * ((fConst15 * fRec3[2]) + (66000.0f * fRec3[1]))));
			fRec3[0] = ((*reinterpret_cast<int*>(&fTempFTZ2) & 2139095040) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fTemp0 - (fSlow38 * ((fSlow39 * fRec4[1]) + (fSlow40 * fRec4[2]))));
			fRec4[0] = ((*reinterpret_cast<int*>(&fTempFTZ3) & 2139095040) ? fTempFTZ3 : 0.0f);
			float fTempFTZ4 = (fTemp0 - (fConst24 * ((fConst25 * fRec6[2]) + (316000.0f * fRec6[1]))));
			fRec6[0] = ((*reinterpret_cast<int*>(&fTempFTZ4) & 2139095040) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fTemp0 - (fSlow61 * ((fSlow62 * fRec7[2]) + (fSlow63 * fRec7[1]))));
			fRec7[0] = ((*reinterpret_cast<int*>(&fTempFTZ5) & 2139095040) ? fTempFTZ5 : 0.0f);
			float fTemp1 = (fConst19 * fRec5[1]);
			float fTempFTZ6 = (((fConst22 * (((fSlow48 * fRec6[0]) + (20000.0f * fRec6[1])) + (fSlow49 * fRec6[2]))) + (8.0f * ((fSlow60 * fRec7[1]) + (fSlow64 * ((fSlow67 * fRec7[0]) + (fSlow68 * fRec7[2])))))) - (((fRec5[2] * fSlow73) + fTemp1) / fSlow74));
			fRec5[0] = ((*reinterpret_cast<int*>(&fTempFTZ6) & 2139095040) ? fTempFTZ6 : 0.0f);
			float fTemp2 = (fConst2 * fRec0[1]);
			float fTempFTZ7 = ((((fSlow1 * ((12.0f * ((fSlow3 * fRec1[0]) + (fSlow4 * fRec1[2]))) + (4.0f * ((fSlow16 * fRec2[1]) + (fSlow20 * ((fSlow22 * fRec2[0]) + (fSlow23 * fRec2[2]))))))) + (fSlow24 * ((6.0f * ((fSlow25 * fRec3[0]) + (fSlow26 * fRec3[2]))) + (1.39999998f * ((fSlow37 * fRec4[1]) + (fSlow41 * ((fSlow44 * fRec4[0]) + (fSlow45 * fRec4[2])))))))) + (fSlow46 * (((fTemp1 + (fRec5[0] * fSlow76)) + (fRec5[2] * fSlow77)) / fSlow74))) - (((fRec0[2] * fSlow82) + fTemp2) / fSlow83));
			fRec0[0] = ((*reinterpret_cast<int*>(&fTempFTZ7) & 2139095040) ? fTempFTZ7 : 0.0f);
			output0[i] = FAUSTFLOAT((((fTemp2 + (fRec0[0] * fSlow85)) + (fRec0[2] * fSlow86)) / fSlow83));
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
