...
static float CabinetFaust_faustpower2_f(float value) {
	return (value * value);
}
...
class CabinetFaust : public FaustImpl {
 ...
 public:
	...
	virtual CabinetFaust* clone() {
		return new CabinetFaust();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("dynamic_level", &fEntry32, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (std::pow(10.0f, (0.100000001f * fSlow0)) * std::pow(10.0f, (0.0500000007f * float(fEntry1))));
		float fSlow2 = float(fEntry2);
		float fSlow3 = std::tan((fConst27 * fSlow2));
		float fSlow4 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow3))));
		float fSlow5 = float(fEntry3);
		float fSlow6 = std::tan((fConst27 * fSlow5));
		float fSlow7 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow6))));
		float fSlow8 = float(fEntry4);
		float fSlow9 = std::tan((fConst27 * fSlow8));
		float fSlow10 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow9))));
		float fSlow11 = float(fEntry5);
		float fSlow12 = std::tan((fConst27 * fSlow11));
		float fSlow13 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow12))));
		float fSlow14 = float(fEntry6);
		float fSlow15 = std::tan((fConst27 * fSlow14));
		float fSlow16 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow15))));
		float fSlow17 = float(fEntry7);
		float fSlow18 = std::tan((fConst27 * fSlow17));
		float fSlow19 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow18))));
		float fSlow20 = float(fEntry8);
		float fSlow21 = std::tan((fConst27 * fSlow20));
		float fSlow22 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow21))));
		float fSlow23 = float(fEntry9);
		float fSlow24 = std::tan((fConst27 * fSlow23));
		float fSlow25 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow24))));
		float fSlow26 = float(fEntry10);
		float fSlow27 = std::tan((fConst27 * fSlow26));
		float fSlow28 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow27))));
		float fSlow29 = float(fEntry11);
		float fSlow30 = std::tan((fConst27 * fSlow29));
		float fSlow31 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow30))));
		...
		float fSlow57 = (2.0f * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fSlow40))));
		...
		float fSlow73 = (fConst27 * ((fSlow71 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow69)))) / fSlow72));
		float fSlow74 = (fConst27 * (fSlow71 / fSlow72));
		float fSlow75 = (iSlow70 ? fSlow74 : fSlow73);
		float fSlow76 = (1.0f - (fSlow68 * (fSlow75 - fSlow68)));
		...
		float fSlow80 = (1.0f - (fSlow68 * (fSlow78 - fSlow68)));
		...
		float fSlow86 = (fConst27 * ((fSlow84 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow82)))) / fSlow85));
		float fSlow87 = (fConst27 * (fSlow84 / fSlow85));
		float fSlow88 = (iSlow83 ? fSlow87 : fSlow86);
		float fSlow89 = (1.0f - (fSlow81 * (fSlow88 - fSlow81)));
		...
		float fSlow93 = (1.0f - (fSlow81 * (fSlow91 - fSlow81)));
		...
		float fSlow99 = (fConst27 * ((fSlow97 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow95)))) / fSlow98));
		float fSlow100 = (fConst27 * (fSlow97 / fSlow98));
		float fSlow101 = (iSlow96 ? fSlow100 : fSlow99);
		float fSlow102 = (1.0f - (fSlow94 * (fSlow101 - fSlow94)));
		...
		float fSlow106 = (1.0f - (fSlow94 * (fSlow104 - fSlow94)));
		...
		float fSlow112 = (fConst27 * ((fSlow110 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow108)))) / fSlow111));
		float fSlow113 = (fConst27 * (fSlow110 / fSlow111));
		float fSlow114 = (iSlow109 ? fSlow113 : fSlow112);
		float fSlow115 = (1.0f - (fSlow107 * (fSlow114 - fSlow107)));
		...
		float fSlow119 = (1.0f - (fSlow107 * (fSlow117 - fSlow107)));
		...
		float fSlow125 = (fConst27 * ((fSlow123 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow121)))) / fSlow124));
		float fSlow126 = (fConst27 * (fSlow123 / fSlow124));
		float fSlow127 = (iSlow122 ? fSlow126 : fSlow125);
		float fSlow128 = (1.0f - (fSlow120 * (fSlow127 - fSlow120)));
		...
		float fSlow132 = (1.0f - (fSlow120 * (fSlow130 - fSlow120)));
		...
		float fSlow138 = (fConst27 * ((fSlow136 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow134)))) / fSlow137));
		float fSlow139 = (fConst27 * (fSlow136 / fSlow137));
		float fSlow140 = (iSlow135 ? fSlow139 : fSlow138);
		float fSlow141 = (1.0f - (fSlow133 * (fSlow140 - fSlow133)));
		...
		float fSlow145 = (1.0f - (fSlow133 * (fSlow143 - fSlow133)));
		...
		float fSlow151 = (fConst27 * ((fSlow149 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow147)))) / fSlow150));
		float fSlow152 = (fConst27 * (fSlow149 / fSlow150));
		float fSlow153 = (iSlow148 ? fSlow152 : fSlow151);
		float fSlow154 = (1.0f - (fSlow146 * (fSlow153 - fSlow146)));
		...
		float fSlow158 = (1.0f - (fSlow146 * (fSlow156 - fSlow146)));
		...
		float fSlow164 = (1.0f / (std::max<float>((0.100000001f * fSlow162), (0.5f * fSlow162)) - fSlow163));
		...
		float fSlow174 = (fConst27 * ((fSlow172 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow170)))) / fSlow173));
		float fSlow175 = (fConst27 * (fSlow172 / fSlow173));
		float fSlow176 = (iSlow171 ? fSlow175 : fSlow174);
		float fSlow177 = (1.0f - (fSlow169 * (fSlow176 - fSlow169)));
		...
		float fSlow181 = (1.0f - (fSlow169 * (fSlow179 - fSlow169)));
		...
		float fSlow187 = (fConst27 * ((fSlow185 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow183)))) / fSlow186));
		float fSlow188 = (fConst27 * (fSlow185 / fSlow186));
		float fSlow189 = (iSlow184 ? fSlow188 : fSlow187);
		float fSlow190 = (1.0f - (fSlow182 * (fSlow189 - fSlow182)));
		...
		float fSlow194 = (1.0f - (fSlow182 * (fSlow192 - fSlow182)));
		...
		float fSlow200 = (fConst27 * ((fSlow198 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow196)))) / fSlow199));
		float fSlow201 = (fConst27 * (fSlow198 / fSlow199));
		float fSlow202 = (iSlow197 ? fSlow201 : fSlow200);
		float fSlow203 = (1.0f - (fSlow195 * (fSlow202 - fSlow195)));
		...
		float fSlow207 = (1.0f - (fSlow195 * (fSlow205 - fSlow195)));
		...
		float fSlow213 = (fConst43 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow211))));
		float fSlow214 = (iSlow212 ? fConst43 : fSlow213);
		float fSlow215 = (1.0f - (fConst42 * (fSlow214 - fConst42)));
		...
		float fSlow219 = (1.0f - (fConst42 * (fSlow217 - fConst42)));
		float fSlow220 = (0.0250000004f * (0.0f - (5.0f * fSlow160)));
		float fSlow221 = (0.0f - (10.0f * fSlow0));
		int iSlow222 = (fSlow221 > 0.0f);
		float fSlow223 = (fConst50 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow221))));
		float fSlow224 = (iSlow222 ? fConst50 : fSlow223);
		float fSlow225 = (1.0f - (fConst49 * (fSlow224 - fConst49)));
		...
		float fSlow229 = (1.0f - (fConst49 * (fSlow227 - fConst49)));
		float fSlow230 = (0.0f - (17.0f * fSlow0));
		int iSlow231 = (fSlow230 > 0.0f);
		float fSlow232 = (fConst52 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow230))));
		float fSlow233 = (iSlow231 ? fConst52 : fSlow232);
		float fSlow234 = (1.0f - (fConst51 * (fSlow233 - fConst51)));
		...
		float fSlow238 = (1.0f - (fConst51 * (fSlow236 - fConst51)));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			float fTempFTZ0 = (fTemp0 - (fSlow51 * ((fSlow52 * fRec26[2]) + (fSlow53 * fRec26[1]))));
			fRec26[0] = ((*reinterpret_cast<int*>(&fTempFTZ0) & 2139095040) ? fTempFTZ0 : 0.0f);
			float fTempFTZ1 = ((fSlow51 * (((fSlow50 * fRec26[0]) + (fSlow54 * fRec26[1])) + (fSlow50 * fRec26[2]))) - (fSlow48 * ((fSlow55 * fRec25[2]) + (fSlow53 * fRec25[1]))));
			fRec25[0] = ((*reinterpret_cast<int*>(&fTempFTZ1) & 2139095040) ? fTempFTZ1 : 0.0f);
			float fTemp1 = (fSlow48 * (((fSlow50 * fRec25[0]) + (fSlow54 * fRec25[1])) + (fSlow50 * fRec25[2])));
			fVec0[0] = fTemp1;
			float fTempFTZ2 = (0.0f - (fSlow44 * ((fSlow45 * fRec24[1]) - (fTemp1 + fVec0[1]))));
			fRec24[0] = ((*reinterpret_cast<int*>(&fTempFTZ2) & 2139095040) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fRec24[0] - (fSlow43 * ((fSlow56 * fRec23[2]) + (fSlow57 * fRec23[1]))));
			fRec23[0] = ((*reinterpret_cast<int*>(&fTempFTZ3) & 2139095040) ? fTempFTZ3 : 0.0f);
			float fTemp2 = (fRec23[2] + (fRec23[0] + (2.0f * fRec23[1])));
			float fTemp3 = (fSlow43 * fTemp2);
			fVec1[0] = fTemp3;
			float fTempFTZ4 = (0.0f - (fSlow38 * ((fSlow39 * fRec22[1]) - (fTemp3 + fVec1[1]))));
			fRec22[0] = ((*reinterpret_cast<int*>(&fTempFTZ4) & 2139095040) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fRec22[0] - (fSlow36 * ((fSlow58 * fRec21[2]) + (fSlow61 * fRec21[1]))));
			fRec21[0] = ((*reinterpret_cast<int*>(&fTempFTZ5) & 2139095040) ? fTempFTZ5 : 0.0f);
			float fTempFTZ6 = ((fSlow36 * (fRec21[2] + (fRec21[0] + (2.0f * fRec21[1])))) - (fSlow35 * ((fSlow62 * fRec20[2]) + (fSlow61 * fRec20[1]))));
			fRec20[0] = ((*reinterpret_cast<int*>(&fTempFTZ6) & 2139095040) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = ((fSlow35 * (fRec20[2] + (fRec20[0] + (2.0f * fRec20[1])))) - (fSlow34 * ((fSlow63 * fRec19[2]) + (fSlow61 * fRec19[1]))));
			fRec19[0] = ((*reinterpret_cast<int*>(&fTempFTZ7) & 2139095040) ? fTempFTZ7 : 0.0f);
			float fTempFTZ8 = ((fSlow65 * fVec1[1]) - (fSlow38 * ((fSlow39 * fRec30[1]) - (fSlow66 * fTemp2))));
			fRec30[0] = ((*reinterpret_cast<int*>(&fTempFTZ8) & 2139095040) ? fTempFTZ8 : 0.0f);
			float fTempFTZ9 = (fRec30[0] - (fSlow36 * ((fSlow58 * fRec29[2]) + (fSlow61 * fRec29[1]))));
			fRec29[0] = ((*reinterpret_cast<int*>(&fTempFTZ9) & 2139095040) ? fTempFTZ9 : 0.0f);
			float fTempFTZ10 = ((fSlow36 * (((fSlow60 * fRec29[0]) + (fSlow67 * fRec29[1])) + (fSlow60 * fRec29[2]))) - (fSlow35 * ((fSlow62 * fRec28[2]) + (fSlow61 * fRec28[1]))));
			fRec28[0] = ((*reinterpret_cast<int*>(&fTempFTZ10) & 2139095040) ? fTempFTZ10 : 0.0f);
			float fTempFTZ11 = ((fSlow35 * (((fSlow60 * fRec28[0]) + (fSlow67 * fRec28[1])) + (fSlow60 * fRec28[2]))) - (fSlow34 * ((fSlow63 * fRec27[2]) + (fSlow61 * fRec27[1]))));
			fRec27[0] = ((*reinterpret_cast<int*>(&fTempFTZ11) & 2139095040) ? fTempFTZ11 : 0.0f);
			float fTemp4 = (fSlow31 * fRec18[1]);
			float fTempFTZ12 = ((fSlow34 * ((fRec19[2] + (fRec19[0] + (2.0f * fRec19[1]))) + (fSlow64 * (((fSlow60 * fRec27[0]) + (fSlow67 * fRec27[1])) + (fSlow60 * fRec27[2]))))) - (((fRec18[2] * fSlow76) + fTemp4) / fSlow77));
			fRec18[0] = ((*reinterpret_cast<int*>(&fTempFTZ12) & 2139095040) ? fTempFTZ12 : 0.0f);
			float fTemp5 = (fSlow28 * fRec17[1]);
			float fTempFTZ13 = ((((fTemp4 + (fRec18[0] * fSlow79)) + (fRec18[2] * fSlow80)) / fSlow77) - (((fRec17[2] * fSlow89) + fTemp5) / fSlow90));
			fRec17[0] = ((*reinterpret_cast<int*>(&fTempFTZ13) & 2139095040) ? fTempFTZ13 : 0.0f);
			float fTemp6 = (fSlow25 * fRec16[1]);
			float fTempFTZ14 = ((((fTemp5 + (fRec17[0] * fSlow92)) + (fRec17[2] * fSlow93)) / fSlow90) - (((fRec16[2] * fSlow102) + fTemp6) / fSlow103));
			fRec16[0] = ((*reinterpret_cast<int*>(&fTempFTZ14) & 2139095040) ? fTempFTZ14 : 0.0f);
			float fTemp7 = (fSlow22 * fRec15[1]);
			float fTempFTZ15 = ((((fTemp6 + (fRec16[0] * fSlow105)) + (fRec16[2] * fSlow106)) / fSlow103) - (((fRec15[2] * fSlow115) + fTemp7) / fSlow116));
			fRec15[0] = ((*reinterpret_cast<int*>(&fTempFTZ15) & 2139095040) ? fTempFTZ15 : 0.0f);
			float fTemp8 = (fSlow19 * fRec14[1]);
			float fTempFTZ16 = ((((fTemp7 + (fRec15[0] * fSlow118)) + (fRec15[2] * fSlow119)) / fSlow116) - (((fRec14[2] * fSlow128) + fTemp8) / fSlow129));
			fRec14[0] = ((*reinterpret_cast<int*>(&fTempFTZ16) & 2139095040) ? fTempFTZ16 : 0.0f);
			float fTemp9 = (fSlow16 * fRec13[1]);
			float fTempFTZ17 = ((((fTemp8 + (fRec14[0] * fSlow131)) + (fRec14[2] * fSlow132)) / fSlow129) - (((fRec13[2] * fSlow141) + fTemp9) / fSlow142));
			fRec13[0] = ((*reinterpret_cast<int*>(&fTempFTZ17) & 2139095040) ? fTempFTZ17 : 0.0f);
			float fTemp10 = (fSlow13 * fRec12[1]);
			float fTempFTZ18 = ((((fTemp9 + (fRec13[0] * fSlow144)) + (fRec13[2] * fSlow145)) / fSlow142) - (((fRec12[2] * fSlow154) + fTemp10) / fSlow155));
			fRec12[0] = ((*reinterpret_cast<int*>(&fTempFTZ18) & 2139095040) ? fTempFTZ18 : 0.0f);
			float fTempFTZ19 = ((fConst29 * fRec31[1]) + (fConst30 * std::fabs(fTemp0)));
			fRec31[0] = ((*reinterpret_cast<int*>(&fTempFTZ19) & 2139095040) ? fTempFTZ19 : 0.0f);
			float fTemp11 = std::max<float>(-1.0f, std::min<float>(1.0f, (0.588235319f * ((fSlow164 * (fRec31[0] - fSlow163)) + -0.5f))));
			...
			float fTemp21 = (fConst27 * ((std::pow(10.0f, (0.0500000007f * std::fabs(fTemp17))) * fTemp19) / fTemp20));
			float fTemp22 = (fConst27 * (fTemp19 / fTemp20));
			float fTemp23 = (iTemp18 ? fTemp22 : fTemp21);
			float fTemp24 = (2.0f * (fRec11[1] * (1.0f - (1.0f / CabinetFaust_faustpower2_f(fTemp15)))));
			float fTemp25 = (((fTemp16 + fTemp23) / fTemp15) + 1.0f);
			float fTempFTZ20 = ((((fTemp10 + (fRec12[0] * fSlow157)) + (fRec12[2] * fSlow158)) / fSlow155) - (((fRec11[2] * (((fTemp16 - fTemp23) / fTemp15) + 1.0f)) + fTemp24) / fTemp25));
			fRec11[0] = ((*reinterpret_cast<int*>(&fTempFTZ20) & 2139095040) ? fTempFTZ20 : 0.0f);
			float fTemp26 = (iTemp18 ? fTemp21 : fTemp22);
			float fTemp27 = (fSlow10 * fRec10[1]);
			float fTempFTZ21 = ((((fTemp24 + (fRec11[0] * (((fTemp16 + fTemp26) / fTemp15) + 1.0f))) + (fRec11[2] * (((fTemp16 - fTemp26) / fTemp15) + 1.0f))) / fTemp25) - (((fRec10[2] * fSlow177) + fTemp27) / fSlow178));
			fRec10[0] = ((*reinterpret_cast<int*>(&fTempFTZ21) & 2139095040) ? fTempFTZ21 : 0.0f);
			float fTemp28 = (fSlow7 * fRec9[1]);
			float fTempFTZ22 = ((((fTemp27 + (fRec10[0] * fSlow180)) + (fRec10[2] * fSlow181)) / fSlow178) - (((fRec9[2] * fSlow190) + fTemp28) / fSlow191));
			fRec9[0] = ((*reinterpret_cast<int*>(&fTempFTZ22) & 2139095040) ? fTempFTZ22 : 0.0f);
			float fTemp29 = (fSlow4 * fRec8[1]);
			float fTempFTZ23 = ((((fTemp28 + (fRec9[0] * fSlow193)) + (fRec9[2] * fSlow194)) / fSlow191) - (((fRec8[2] * fSlow203) + fTemp29) / fSlow204));
			fRec8[0] = ((*reinterpret_cast<int*>(&fTempFTZ23) & 2139095040) ? fTempFTZ23 : 0.0f);
			float fTemp30 = (fConst26 * fRec7[1]);
			float fTempFTZ24 = ((((fTemp29 + (fRec8[0] * fSlow206)) + (fRec8[2] * fSlow207)) / fSlow204) - (fConst23 * ((fConst31 * fRec7[2]) + fTemp30)));
			fRec7[0] = ((*reinterpret_cast<int*>(&fTempFTZ24) & 2139095040) ? fTempFTZ24 : 0.0f);
			float fTemp31 = ((fTemp30 + (fConst33 * fRec7[0])) + (fConst34 * fRec7[2]));
			fVec2[0] = fTemp31;
			float fTempFTZ25 = ((fConst23 * ((fConst25 * fTemp31) + (fConst35 * fVec2[1]))) - (fConst37 * fRec6[1]));
			fRec6[0] = ((*reinterpret_cast<int*>(&fTempFTZ25) & 2139095040) ? fTempFTZ25 : 0.0f);
			float fTempFTZ26 = (fRec6[0] - (fConst16 * ((fConst38 * fRec5[2]) + (fConst39 * fRec5[1]))));
			fRec5[0] = ((*reinterpret_cast<int*>(&fTempFTZ26) & 2139095040) ? fTempFTZ26 : 0.0f);
			float fTempFTZ27 = (0.0f - (fConst41 * ((fConst36 * fRec33[1]) - (fConst23 * (fTemp31 + fVec2[1])))));
			fRec33[0] = ((*reinterpret_cast<int*>(&fTempFTZ27) & 2139095040) ? fTempFTZ27 : 0.0f);
			float fTempFTZ28 = (fRec33[0] - (fConst16 * ((fConst38 * fRec32[2]) + (fConst39 * fRec32[1]))));
			fRec32[0] = ((*reinterpret_cast<int*>(&fTempFTZ28) & 2139095040) ? fTempFTZ28 : 0.0f);
			float fTemp32 = (fConst13 * fRec4[1]);
			float fTempFTZ29 = ((fConst16 * ((((fConst18 * fRec5[0]) + (fConst40 * fRec5[1])) + (fConst18 * fRec5[2])) + ((fRec32[2] + (fRec32[0] + (2.0f * fRec32[1]))) * std::pow(10.0f, (0.0500000007f * ((fSlow208 * fTemp13) - fSlow210)))))) - (((fRec4[2] * fSlow215) + fTemp32) / fSlow216));
			fRec4[0] = ((*reinterpret_cast<int*>(&fTempFTZ29) & 2139095040) ? fTempFTZ29 : 0.0f);
			float fTemp33 = (((fTemp32 + (fRec4[0] * fSlow218)) + (fRec4[2] * fSlow219)) / fSlow216);
			fVec3[0] = fTemp33;
			float fTempFTZ30 = ((fConst11 * fVec3[1]) - (fConst44 * ((fConst45 * fRec3[1]) - (fConst6 * fTemp33))));
			fRec3[0] = ((*reinterpret_cast<int*>(&fTempFTZ30) & 2139095040) ? fTempFTZ30 : 0.0f);
			float fTempFTZ31 = (fRec3[0] - (fConst7 * ((fConst46 * fRec2[2]) + (fConst47 * fRec2[1]))));
			fRec2[0] = ((*reinterpret_cast<int*>(&fTempFTZ31) & 2139095040) ? fTempFTZ31 : 0.0f);
			float fTempFTZ32 = (0.0f - (fConst44 * ((fConst45 * fRec35[1]) - (fTemp33 + fVec3[1]))));
			fRec35[0] = ((*reinterpret_cast<int*>(&fTempFTZ32) & 2139095040) ? fTempFTZ32 : 0.0f);
			float fTempFTZ33 = (fRec35[0] - (fConst7 * ((fConst46 * fRec34[2]) + (fConst47 * fRec34[1]))));
			fRec34[0] = ((*reinterpret_cast<int*>(&fTempFTZ33) & 2139095040) ? fTempFTZ33 : 0.0f);
			float fTemp34 = (fConst4 * fRec1[1]);
			float fTempFTZ34 = ((fConst7 * (((((fConst9 * fRec2[0]) + (fConst48 * fRec2[1])) + (fConst9 * fRec2[2])) * std::pow(10.0f, (fSlow220 * fTemp13))) + (fRec34[2] + (fRec34[0] + (2.0f * fRec34[1]))))) - (((fRec1[2] * fSlow225) + fTemp34) / fSlow226));
			fRec1[0] = ((*reinterpret_cast<int*>(&fTempFTZ34) & 2139095040) ? fTempFTZ34 : 0.0f);
			float fTemp35 = (fConst2 * fRec0[1]);
			float fTempFTZ35 = ((((fTemp34 + (fRec1[0] * fSlow228)) + (fRec1[2] * fSlow229)) / fSlow226) - (((fRec0[2] * fSlow234) + fTemp35) / fSlow235));
			fRec0[0] = ((*reinterpret_cast<int*>(&fTempFTZ35) & 2139095040) ? fTempFTZ35 : 0.0f);
			output0[i] = FAUSTFLOAT((fSlow1 * (((fTemp35 + (fRec0[0] * fSlow237)) + (fRec0[2] * fSlow238)) / fSlow235)));
			fRec26[2] = fRec26[1];
			fRec26[1] = fRec26[0];
			fRec25[2] = fRec25[1];
			fRec25[1] = fRec25[0];
