...
class TetrodePlateFaust : public FaustImpl {
 ...
 public:
	...
	virtual TetrodePlateFaust* clone() {
		return new TetrodePlateFaust();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("clip", &fEntry9, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("clip_corner", &fEntry4, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("comp_depth", &fEntry10, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("comp_tau", &fEntry11, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("cross_corner", &fEntry12, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("drift2_depth", &fEntry17, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("drift2_level", &fEntry18, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("drift_depth", &fEntry6, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("drift_level", &fEntry8, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->addNumEntry("drift_tau", &fEntry7, 0.0f, 0.0f, 1.0f, 1.0f);
		...
		ui_interface->addNumEntry("scale", &fEntry5, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = std::tan((fConst3 * std::min<float>(fConst4, float(fEntry0))));
		float fSlow1 = TetrodePlateFaust_faustpower2_f(std::sqrt((fConst6 * (fSlow0 * std::tan((fConst3 * std::min<float>(fConst4, float(fEntry1))))))));
		...
		float fSlow31 = (fSlow11 / fSlow18);
		float fSlow32 = (1.0f - (1.0f / ((fConst0 * (fSlow27 * float(fEntry16))) + 1.0f)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTempFTZ0 = ((fSlow15 * fRec1[1]) + (fSlow16 * (std::max<float>(fSlow17, fTemp1) - fSlow17)));
			fRec1[0] = ((*reinterpret_cast<int*>(&fTempFTZ0) & 2139095040) ? fTempFTZ0 : 0.0f);
			float fTemp2 = (fSlow12 * fRec1[0]);
			float fTempFTZ1 = ((fSlow22 * fRec2[1]) + (fSlow23 * std::min<float>(1.0f, std::fabs((fSlow24 * (fTemp1 - fTemp2))))));
			fRec2[0] = ((*reinterpret_cast<int*>(&fTempFTZ1) & 2139095040) ? fTempFTZ1 : 0.0f);
			float fTemp3 = (fSlow18 / ((fSlow19 * fRec2[0]) + 1.0f));
			float fTemp4 = (fSlow9 + (fTemp1 - (fTemp2 + fTemp3)));
			float fTemp5 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow10 * std::max<float>(0.0f, fTemp4))));
			float fTemp6 = (fTemp5 * (std::fabs(fTemp5) + -2.0f));
			float fTemp7 = (((fSlow9 * ((fTemp6 * (std::fabs(fTemp6) + -2.0f)) + -1.0f)) + (fTemp3 + std::min<float>(0.0f, fTemp4))) - fSlow25);
			float fTempFTZ2 = ((fRec3[1] * fSlow15) + ((std::max<float>(fSlow17, (0.0f - fTemp1)) - fSlow17) * fSlow16));
			fRec3[0] = ((*reinterpret_cast<int*>(&fTempFTZ2) & 2139095040) ? fTempFTZ2 : 0.0f);
			float fTemp8 = (fTemp1 + (fSlow12 * fRec3[0]));
			float fTempFTZ3 = ((fRec4[1] * fSlow22) + (std::min<float>(1.0f, std::fabs((fSlow24 * (0.0f - fTemp8)))) * fSlow23));
			fRec4[0] = ((*reinterpret_cast<int*>(&fTempFTZ3) & 2139095040) ? fTempFTZ3 : 0.0f);
			float fTemp9 = (fSlow18 / ((fSlow19 * fRec4[0]) + 1.0f));
			float fTemp10 = (fSlow9 - (fTemp8 + fTemp9));
			float fTemp11 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow10 * std::max<float>(0.0f, fTemp10))));
			float fTemp12 = (fTemp11 * (std::fabs(fTemp11) + -2.0f));
			float fTemp13 = (((fSlow9 * ((fTemp12 * (std::fabs(fTemp12) + -2.0f)) + -1.0f)) + (fTemp9 + std::min<float>(0.0f, fTemp10))) - fSlow25);
			float fTemp14 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow26 * std::min<float>(0.0f, fTemp13))));
			float fTemp15 = (fTemp14 * (std::fabs(fTemp14) + -2.0f));
			float fTemp16 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow26 * std::min<float>(0.0f, fTemp7))));
			float fTemp17 = (fTemp16 * (std::fabs(fTemp16) + -2.0f));
			float fTemp18 = std::fabs((fSlow31 * fTemp0));
			float fTempFTZ4 = ((fSlow28 * std::max<float>(0.0f, ((fSlow29 * ((fSlow30 * std::min<float>(1.0f, fTemp18)) + std::max<float>(1.0f, fTemp18))) - fRec5[1]))) + (fSlow32 * fRec5[1]));
			fRec5[0] = ((*reinterpret_cast<int*>(&fTempFTZ4) & 2139095040) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = ((fSlow8 * ((std::max<float>(0.0f, fTemp7) - (std::max<float>(0.0f, fTemp13) + (fSlow25 * (((fTemp15 * (std::fabs(fTemp15) + -2.0f)) + 1.0f) - ((fTemp17 * (std::fabs(fTemp17) + -2.0f)) + 1.0f))))) / ((fSlow7 * fRec5[0]) + 1.0f))) - (fSlow33 * ((fSlow34 * fRec0[1]) + (fSlow35 * fRec0[2]))));
			fRec0[0] = ((*reinterpret_cast<int*>(&fTempFTZ5) & 2139095040) ? fTempFTZ5 : 0.0f);
			float fTemp19 = ((fSlow6 * fRec0[0]) + (fSlow36 * fRec0[2]));
			float fTempFTZ6 = ((fSlow15 * fRec6[1]) + (fSlow16 * (std::max<float>(fSlow38, std::fabs(fTemp19)) - fSlow38)));
			fRec6[0] = ((*reinterpret_cast<int*>(&fTempFTZ6) & 2139095040) ? fTempFTZ6 : 0.0f);
