...
class AmpMono {
 ...
 public:
	...
	void set_cab_brightness(FAUSTFLOAT value) { fEntry60 = value + 0.000000e+00f; }
	...
	void set_tetrode_grid_cap(FAUSTFLOAT value) { fEntry44 = value + 2.464347e+00f; }
	void set_tetrode_grid_level(FAUSTFLOAT value) { fEntry45 = value + 4.247939e-01f; }
	void set_tetrode_grid_offset1(FAUSTFLOAT value) { fEntry40 = value + 4.772563e-02f; }
	void set_tetrode_grid_offset2(FAUSTFLOAT value) { fEntry42 = value + -2.047726e+00f; }
	void set_tetrode_grid_ratio(FAUSTFLOAT value) { fEntry46 = value + 6.315747e-01f; }
	void set_tetrode_grid_tau(FAUSTFLOAT value) { fEntry43 = value + -6.191922e-01f; }
	void set_tetrode_grid_taus(FAUSTFLOAT value) { fEntry41 = value + -3.828938e-05f; }
	void set_tetrode_hp_freq(FAUSTFLOAT value) { fEntry4 = value + -2.881448e+00f; }
	void set_tetrode_lp_freq(FAUSTFLOAT value) { fEntry3 = value + 4.861658e-01f; }
	void set_tetrode_plate_clip(FAUSTFLOAT value) { fEntry50 = value + 5.106009e-01f; }
	void set_tetrode_plate_clip_corner(FAUSTFLOAT value) { fEntry7 = value + 1.071034e+00f; }
	void set_tetrode_plate_comp_depth(FAUSTFLOAT value) { fEntry51 = value + -5.419920e-01f; }
	void set_tetrode_plate_comp_tau(FAUSTFLOAT value) { fEntry52 = value + -1.311079e+00f; }
	void set_tetrode_plate_cross_corner(FAUSTFLOAT value) { fEntry53 = value + 5.972299e-01f; }
	void set_tetrode_plate_drift2_depth(FAUSTFLOAT value) { fEntry57 = value + -1.112544e-02f; }
	void set_tetrode_plate_drift2_level(FAUSTFLOAT value) { fEntry58 = value + 5.639156e-01f; }
	void set_tetrode_plate_drift_depth(FAUSTFLOAT value) { fEntry47 = value + 1.738535e-01f; }
	void set_tetrode_plate_drift_level(FAUSTFLOAT value) { fEntry49 = value + 1.148487e+00f; }
	void set_tetrode_plate_drift_tau(FAUSTFLOAT value) { fEntry48 = value + -2.438887e-01f; }
	...
	void set_tetrode_plate_scale(FAUSTFLOAT value) { fEntry8 = value + 3.358314e-01f; }
	void set_triode_grid_cap(FAUSTFLOAT value) { fEntry31 = value + 1.743836e+00f; }
	void set_triode_grid_clip(FAUSTFLOAT value) { fEntry22 = value + 5.547782e-01f; }
	void set_triode_grid_corner(FAUSTFLOAT value) { fEntry23 = value + 1.641426e-01f; }
	void set_triode_grid_level(FAUSTFLOAT value) { fEntry32 = value + 3.352703e-01f; }
	void set_triode_grid_ratio(FAUSTFLOAT value) { fEntry33 = value + 1.209338e+00f; }
	void set_triode_grid_smooth(FAUSTFLOAT value) { fEntry30 = value + 1.510794e+00f; }
	void set_triode_grid_tau(FAUSTFLOAT value) { fEntry29 = value + -1.357839e+00f; }
	void set_triode_hp_freq(FAUSTFLOAT value) { fEntry24 = value + 4.527303e-01f; }
	void set_triode_plate_bias(FAUSTFLOAT value) { fEntry19 = value + 2.364891e+00f; }
	void set_triode_plate_bias_corner(FAUSTFLOAT value) { fEntry21 = value + 4.887126e-01f; }
	void set_triode_plate_clip(FAUSTFLOAT value) { fEntry18 = value + -1.077285e+00f; }
	void set_triode_plate_comp_cap(FAUSTFLOAT value) { fEntry16 = value + 2.530666e+00f; }
	void set_triode_plate_comp_corner(FAUSTFLOAT value) { fEntry25 = value + 1.733029e-02f; }
	void set_triode_plate_comp_depth(FAUSTFLOAT value) { fEntry14 = value + -1.562768e-01f; }
	void set_triode_plate_comp_level(FAUSTFLOAT value) { fEntry17 = value + -1.007034e+00f; }
	void set_triode_plate_comp_offset(FAUSTFLOAT value) { fEntry26 = value + 0.000000e+00f; }
	void set_triode_plate_comp_ratio(FAUSTFLOAT value) { fEntry37 = value + 3.113354e+00f; }
	void set_triode_plate_comp_tau(FAUSTFLOAT value) { fEntry15 = value + -1.099083e+00f; }
	void set_triode_plate_corner(FAUSTFLOAT value) { fEntry20 = value + 2.359280e-01f; }
	void set_triode_plate_drift_depth(FAUSTFLOAT value) { fEntry34 = value + -8.258674e-01f; }
	void set_triode_plate_drift_level(FAUSTFLOAT value) { fEntry36 = value + 1.020547e-01f; }
	void set_triode_plate_drift_tau(FAUSTFLOAT value) { fEntry35 = value + -1.084001e+00f; }
	void set_triode_plate_scale(FAUSTFLOAT value) { fEntry2 = value + 1.524131e+00f; }
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow13 = (0.5f * ((float(fEntry5) + 1.0f) * std::exp(((2.30258512f * (float(fEntry6) + 1.0f)) + -2.30258512f))));
		float fSlow14 = (fSlow13 + 1.0f);
		float fSlow15 = std::exp(((3.45387769f * (float(fEntry7) + 1.0f)) + -2.30258512f));
		float fSlow16 = std::exp(((4.60517025f * (float(fEntry8) + 1.0f)) + -4.60517025f));
		float fSlow17 = std::tan((fConst3 * std::exp(((3.45387769f * fSlow5) + -2.30258512f))));
		...
		float fSlow22 = (fSlow2 * std::exp(((3.45387769f * fSlow21) + -0.693147182f)));
		float fSlow23 = float(fEntry10);
		int iSlow24 = (fSlow23 < 0.0f);
		float fSlow25 = std::tan((fConst3 * ((iSlow24?(1500.0f * fSlow23):0.0f) + 2000.0f)));
		...
		float fSlow31 = std::tan((fConst3 * ((400.0f * fSlow30) + (25.0f * fSlow29))));
		...
		float fSlow41 = std::exp(((2.30258512f * (float(fEntry14) + 1.0f)) + -2.30258512f));
		float fSlow42 = std::exp(((3.45387769f * (float(fEntry15) + 1.0f)) + -6.90775537f));
		float fSlow43 = std::exp(((2.30258512f * (float(fEntry16) + 1.0f)) + -2.30258512f));
		...
		float fSlow51 = std::exp(((4.60517025f * (float(fEntry20) + 1.0f)) + -4.60517025f));
		float fSlow52 = (fSlow51 + fSlow48);
		float fSlow53 = std::exp(((4.60517025f * (float(fEntry21) + 1.0f)) + -2.30258512f));
		...
		float fSlow60 = std::exp(((3.45387769f * (float(fEntry24) + 1.0f)) + -2.30258512f));
		...
		float fSlow65 = std::exp(((3.45387769f * (float(fEntry25) + 1.0f)) + -2.30258512f));
		...
		float fSlow78 = std::max<float>(0.0f, (std::min<float>(5.0f, fSlow35) + -3.0f));
		float fSlow79 = (1.0f - (0.5f * fSlow78));
		float fSlow80 = std::max<float>(0.0f, (std::min<float>(3.0f, fSlow35) + -1.0f));
		...
		float fSlow96 = (std::exp((3.80045128f * fSlow95)) * std::pow(10.0f, (0.0500000007f * (0.0f - (35.0f * (1.0f - (float(fEntry28) + 1.0f)))))));
		float fSlow97 = (1.0f / fSlow63);
		float fSlow98 = (1.0f - fSlow62);
		float fSlow99 = (fSlow96 / fSlow61);
		float fSlow100 = std::exp(((3.45387769f * (float(fEntry29) + 1.0f)) + -13.8155107f));
		float fSlow101 = (fSlow100 * std::exp(((6.90775537f * (float(fEntry30) + 1.0f)) + -11.5129251f)));
		float fSlow102 = (1.0f / ((fConst18 * fSlow101) + 1.0f));
		float fSlow103 = (1.0f - fSlow102);
		float fSlow104 = std::exp(((2.30258512f * (float(fEntry31) + 1.0f)) + -2.30258512f));
		...
		float fSlow108 = (fSlow100 * std::exp(((5.75646257f * (float(fEntry33) + 1.0f)) + -2.30258512f)));
		float fSlow109 = (1.0f / ((fConst19 * fSlow108) + 1.0f));
		float fSlow110 = (1.0f - fSlow109);
		float fSlow111 = (0.117647059f / fSlow58);
		float fSlow112 = std::exp(((2.30258512f * (float(fEntry34) + 1.0f)) + -2.30258512f));
		float fSlow113 = std::exp(((3.45387769f * (float(fEntry35) + 1.0f)) + -6.90775537f));
		...
		float fSlow119 = (fSlow42 * std::exp((1.15129256f * (float(fEntry37) + 1.0f))));
		...
		float fSlow163 = std::pow(10.0f, (0.0500000007f * (fSlow28 * ((18.0f * fSlow30) + (4.5f * fSlow29)))));
		float fSlow164 = float(fEntry38);
		float fSlow165 = (fSlow164 + 1.0f);
		float fSlow166 = ((fSlow164 * ((10.0f * (1.0f - (0.5f * fSlow165))) + (2.5f * fSlow165))) + -14.0f);
		int iSlow167 = (fSlow166 > 0.0f);
		float fSlow168 = ((800.0f * fSlow164) + 1200.0f);
		float fSlow169 = (fConst32 * (fSlow168 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow166)))));
		...
		float fSlow179 = (fConst33 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow177))));
		...
		float fSlow189 = std::pow(10.0f, ((0.0500000007f * fSlow23) * (iSlow24?18.0f:9.0f)));
		float fSlow190 = (10.0f * float(fEntry39));
		int iSlow191 = (fSlow190 > 0.0f);
		float fSlow192 = (fConst37 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow190))));
		...
		float fSlow209 = std::pow(10.0f, (0.0500000007f * (iSlow200?(iSlow201?(iSlow202?(iSlow203?(iSlow204?(iSlow205?(iSlow206?(iSlow207?(iSlow208?((fSlow199 < 0.0f)?13.6999998f:(iSlow208?(13.6999998f - (32.9500008f * fSlow95)):7.11000013f)):(iSlow207?(7.11000013f - (6.57700014f * (fSlow199 + -1.0f))):0.532999992f)):(iSlow206?(0.532999992f - (6.5630002f * (fSlow199 + -2.0f))):-6.03000021f)):(iSlow205?(-6.03000021f - (6.57000017f * (fSlow199 + -3.0f))):-12.6000004f)):(iSlow204?(-12.6000004f - (5.19999981f * (fSlow199 + -4.0f))):-17.7999992f)):(iSlow203?(-17.7999992f - (2.79999995f * (0.0f - (5.0f * (1.0f - fSlow95))))):-20.6000004f)):(iSlow202?(-20.6000004f - (1.39999998f * (fSlow199 + -6.0f))):-22.0f)):(iSlow201?(-22.0f - (1.10000002f * (fSlow199 + -7.0f))):-23.1000004f)):(iSlow200?(-23.1000004f - (2.20000005f * (fSlow199 + -8.0f))):-25.2999992f)):((fSlow199 < 10.0f)?(-25.2999992f - (1.70000005f * (fSlow199 + -9.0f))):-27.0f))));
		float fSlow210 = (250.0f * (float(fEntry40) + 1.0f));
		float fSlow211 = (1.0f / fSlow19);
		float fSlow212 = (1.0f - fSlow18);
		float fSlow213 = std::exp((0.0f - (fConst7 / std::exp(((4.60517025f * (float(fEntry41) + 1.0f)) + -9.2103405f)))));
		float fSlow214 = (1.0f - fSlow213);
		float fSlow215 = (250.0f * (float(fEntry42) + 1.0f));
		float fSlow216 = std::exp(((4.60517025f * (float(fEntry43) + 1.0f)) + -9.2103405f));
		float fSlow217 = std::exp(((2.30258512f * (float(fEntry44) + 1.0f)) + -2.30258512f));
		float fSlow218 = (1.0f / (((fConst0 * fSlow216) + 1.0f) * fSlow217));
		float fSlow219 = (100.0f * (1.0f - (float(fEntry45) + 1.0f)));
		float fSlow220 = (1.0f - (1.0f / ((fConst0 * (fSlow216 * std::exp(((4.60517025f * (float(fEntry46) + 1.0f)) + -4.60517025f)))) + 1.0f)));
		float fSlow221 = std::exp(((2.30258512f * (float(fEntry47) + 1.0f)) + -2.30258512f));
		float fSlow222 = std::exp((0.0f - (fConst7 / std::exp(((3.45387769f * (float(fEntry48) + 1.0f)) + -6.90775537f)))));
		...
		float fSlow227 = std::exp(((2.30258512f * (float(fEntry51) + 1.0f)) + -2.30258512f));
		float fSlow228 = std::exp((0.0f - (fConst7 / std::exp(((3.45387769f * (float(fEntry52) + 1.0f)) + -6.90775537f)))));
		float fSlow229 = (1.0f - fSlow228);
		float fSlow230 = (1.0f / fSlow226);
		float fSlow231 = (0.294117659f / fSlow15);
		float fSlow232 = std::exp(((3.45387769f * (float(fEntry53) + 1.0f)) + -2.30258512f));
		float fSlow233 = (0.294117659f / fSlow232);
		float fSlow234 = std::exp(((1.95601153f * (float(fEntry54) + 1.0f)) + -4.60517025f));
		float fSlow235 = (1.0f / ((fConst0 * fSlow234) + 1.0f));
		float fSlow236 = (fSlow16 / fSlow226);
		float fSlow237 = std::exp(((2.30258512f * (float(fEntry55) + 1.0f)) + -2.30258512f));
		float fSlow238 = (1.0f - (1.0f / ((fConst0 * (fSlow234 * std::exp((1.15129256f * (float(fEntry56) + 1.0f))))) + 1.0f)));
		float fSlow239 = (1.0f / fSlow10);
		float fSlow240 = ((fConst38 * fSlow6) + -8.0f);
		float fSlow241 = (fSlow8 + (4.0f - fSlow9));
		float fSlow242 = std::exp(((2.30258512f * (float(fEntry57) + 1.0f)) + -2.30258512f));
		...
		float fSlow249 = (fConst43 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow247))));
		float fSlow250 = (iSlow248?fSlow249:fConst43);
		float fSlow251 = ((fConst42 * (fConst42 - fSlow250)) + 1.0f);
		float fSlow252 = float(fEntry60);
		float fSlow253 = std::pow(10.0f, (0.0500000007f * (0.0f - (3.0f * fSlow252))));
		float fSlow254 = (15.0f * fSlow252);
		int iSlow255 = (fSlow254 > 0.0f);
		float fSlow256 = (fConst198 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow254))));
		...
		float fSlow269 = (fConst201 * std::pow(10.0f, (0.0500000007f * std::fabs(fSlow267))));
		...
		float fSlow286 = std::pow(10.0f, (0.0500000007f * (iSlow277?(iSlow278?(iSlow279?(iSlow280?(iSlow281?(iSlow282?(iSlow283?(iSlow284?(iSlow285?((fSlow276 < 0.0f)?5.28000021f:(iSlow285?(5.28000021f - (27.9400005f * fSlow21)):-0.307999998f)):(iSlow284?(-0.307999998f - (5.28200006f * (fSlow276 + -1.0f))):-5.59000015f)):(iSlow283?(-5.59000015f - (5.40999985f * (fSlow276 + -2.0f))):-11.0f)):(iSlow282?(-11.0f - (5.4000001f * (fSlow276 + -3.0f))):-16.3999996f)):(iSlow281?(-16.3999996f - (3.20000005f * (fSlow276 + -4.0f))):-19.6000004f)):(iSlow280?((5.0f * (1.0f - fSlow21)) + -19.6000004f):-20.6000004f)):(iSlow279?(-20.6000004f - (0.300000012f * (fSlow276 + -6.0f))):-20.8999996f)):(iSlow278?(-20.8999996f - (0.200000003f * (fSlow276 + -7.0f))):-21.1000004f)):(iSlow277?(-21.1000004f - (0.300000012f * (fSlow276 + -8.0f))):-21.3999996f)):((fSlow276 < 10.0f)?(-21.3999996f - (0.100000001f * (fSlow276 + -9.0f))):-21.5f))));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			fVec0[0] = (fSlow96 * fTemp0);
			fRec20[0] = ((fSlow64 * fVec0[1]) - (fSlow97 * ((fSlow98 * fRec20[1]) - (fSlow99 * fTemp0))));
			fRec22[0] = ((fSlow105 * (std::max<float>(0.0f, (std::max<float>(0.0f, (fRec20[0] - fSlow107)) - fRec22[1])) * std::max<float>(0.0f, (fSlow104 - fRec22[1])))) + (fSlow110 * fRec22[1]));
			fRec21[0] = ((fSlow103 * fRec21[1]) + (fSlow102 * fRec22[0]));
			float fTemp1 = (fSlow59 + ((fRec20[0] - fRec21[0]) - fSlow57));
			float fTemp2 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp1))));
			float fTemp3 = (fTemp2 * (std::fabs(fTemp2) + -2.0f));
			float fTemp4 = (fSlow50 + ((fSlow55 * (fSlow57 + (std::min<float>(0.0f, fTemp1) - (fSlow59 * (1.0f - (fTemp3 * (std::fabs(fTemp3) + -2.0f))))))) - fSlow53));
			float fTemp5 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow54 * std::min<float>(0.0f, fTemp4))));
			float fTemp6 = (std::fabs(fTemp5) + -2.0f);
			float fTemp7 = (fSlow50 - (fSlow52 + ((fSlow53 * (((fTemp6 * (std::fabs((fTemp6 * fTemp5)) + -2.0f)) * fTemp5) + 1.0f)) + std::max<float>(0.0f, fTemp4))));
			float fTemp8 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp7))));
			float fTemp9 = (fTemp8 * (std::fabs(fTemp8) + -2.0f));
			float fTemp10 = ((fSlow51 * ((fTemp9 * (std::fabs(fTemp9) + -2.0f)) + 1.0f)) + std::max<float>(0.0f, fTemp7));
			fRec23[0] = ((fSlow115 * (std::max<float>(fSlow118, (fSlow48 + fTemp10)) - fSlow118)) + (fSlow114 * fRec23[1]));
			float fTemp11 = (fSlow112 * fRec23[0]);
			fRec19[0] = ((fSlow44 * (std::max<float>(0.0f, (fSlow43 - fRec19[1])) * std::max<float>(0.0f, ((std::max<float>(fSlow46, (fSlow48 + (fTemp10 - fTemp11))) - fRec19[1]) - fSlow46)))) + (fSlow121 * fRec19[1]));
			float fTemp12 = (fSlow41 * fRec19[0]);
			float fTemp13 = (fSlow85 + (fTemp10 - (fTemp11 + fTemp12)));
			float fTemp14 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp13))));
			float fTemp15 = (fTemp14 * (std::fabs(fTemp14) + -2.0f));
			float fTemp16 = (((fTemp12 + std::min<float>(0.0f, fTemp13)) - (fSlow65 * (1.0f - (fTemp15 * (std::fabs(fTemp15) + -2.0f))))) - fSlow66);
			fVec1[0] = fTemp16;
			fRec18[0] = ((0.900575519f * (fTemp16 + fVec1[1])) - (0.801151097f * fRec18[1]));
			fVec2[0] = (fSlow125 * fRec18[0]);
			fRec17[0] = ((fSlow92 * ((fSlow94 * fRec18[0]) - (fSlow123 * fRec17[1]))) + (fSlow124 * fVec2[1]));
			fRec25[0] = ((fSlow128 * (std::max<float>(0.0f, (fSlow104 - fRec25[1])) * std::max<float>(0.0f, (std::max<float>(0.0f, (fRec17[0] - fSlow129)) - fRec25[1])))) + (fSlow130 * fRec25[1]));
			fRec24[0] = ((fSlow127 * fRec24[1]) + (fSlow126 * fRec25[0]));
			float fTemp17 = (fSlow59 + ((fRec17[0] - fRec24[0]) - fSlow88));
			float fTemp18 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp17))));
			float fTemp19 = ((std::fabs(fTemp18) + -2.0f) * fTemp18);
			float fTemp20 = (fSlow86 + ((fSlow87 * (fSlow88 + (std::min<float>(0.0f, fTemp17) - (fSlow59 * (1.0f - (fTemp19 * (std::fabs(fTemp19) + -2.0f))))))) - fSlow53));
			...
			float fTemp23 = (fSlow86 - (fSlow52 + ((fSlow53 * ((((std::fabs((fTemp22 * fTemp21)) + -2.0f) * fTemp22) * fTemp21) + 1.0f)) + std::max<float>(0.0f, fTemp20))));
			float fTemp24 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp23))));
			float fTemp25 = (std::fabs(fTemp24) + -2.0f);
			float fTemp26 = (std::max<float>(0.0f, fTemp23) + (fSlow51 * ((((std::fabs((fTemp25 * fTemp24)) + -2.0f) * fTemp25) * fTemp24) + 1.0f)));
			fRec26[0] = ((fSlow132 * (std::max<float>(fSlow133, (fSlow48 + fTemp26)) - fSlow133)) + (fSlow131 * fRec26[1]));
			float fTemp27 = (fSlow112 * fRec26[0]);
			fRec27[0] = ((fSlow134 * (std::max<float>(0.0f, (fSlow43 - fRec27[1])) * std::max<float>(0.0f, ((std::max<float>(fSlow135, (fSlow48 + (fTemp26 - fTemp27))) - fRec27[1]) - fSlow135)))) + (fSlow137 * fRec27[1]));
			float fTemp28 = (fSlow41 * fRec27[0]);
			float fTemp29 = (fSlow85 + (fTemp26 - (fTemp27 + fTemp28)));
			float fTemp30 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp29))));
			float fTemp31 = (std::fabs(fTemp30) + -2.0f);
			float fTemp32 = (((std::min<float>(0.0f, fTemp29) + fTemp28) - (fSlow65 * (1.0f - (((std::fabs((fTemp30 * fTemp31)) + -2.0f) * fTemp30) * fTemp31)))) - fSlow66);
			fVec3[0] = fTemp32;
			fRec16[0] = ((0.900575519f * (fTemp32 + fVec3[1])) - (0.801151097f * fRec16[1]));
			fVec4[0] = (fSlow3 * fRec16[0]);
			fRec15[0] = ((fSlow76 * fVec4[1]) - (fSlow138 * ((fSlow139 * fRec15[1]) - (fSlow141 * fRec16[0]))));
			fRec29[0] = ((fSlow143 * (std::max<float>(0.0f, (std::max<float>(0.0f, (fRec15[0] - fSlow129)) - fRec29[1])) * std::max<float>(0.0f, (fSlow104 - fRec29[1])))) - (fSlow144 * fRec29[1]));
			fRec28[0] = ((fSlow142 * fRec29[0]) + (fSlow145 * fRec28[1]));
			float fTemp33 = (fSlow59 + ((fRec15[0] - fRec28[0]) - fSlow72));
			float fTemp34 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp33))));
			float fTemp35 = (std::fabs(fTemp34) + -2.0f);
			float fTemp36 = (fSlow69 + ((fSlow71 * (fSlow72 + (std::min<float>(0.0f, fTemp33) - (fSlow59 * (1.0f - ((fTemp34 * (std::fabs((fTemp34 * fTemp35)) + -2.0f)) * fTemp35)))))) - fSlow53));
			...
			float fTemp39 = (fSlow69 - (fSlow70 + (std::max<float>(0.0f, fTemp36) + (fSlow53 * ((((std::fabs((fTemp38 * fTemp37)) + -2.0f) * fTemp38) * fTemp37) + 1.0f)))));
			float fTemp40 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp39))));
			float fTemp41 = (fTemp40 * (std::fabs(fTemp40) + -2.0f));
			float fTemp42 = ((fSlow51 * ((fTemp41 * (std::fabs(fTemp41) + -2.0f)) + 1.0f)) + std::max<float>(0.0f, fTemp39));
			fRec30[0] = ((fSlow132 * (fSlow116 + std::max<float>(fSlow117, (fSlow67 + fTemp42)))) + (fSlow131 * fRec30[1]));
			float fTemp43 = (fSlow112 * fRec30[0]);
			fRec14[0] = ((fSlow82 * (std::max<float>(0.0f, (fSlow43 - fRec14[1])) * std::max<float>(0.0f, ((std::max<float>(fSlow83, (fSlow67 + (fTemp42 - fTemp43))) - fRec14[1]) - fSlow83)))) + (fSlow146 * fRec14[1]));
			float fTemp44 = (fSlow41 * fRec14[0]);
			float fTemp45 = (fSlow68 + (fTemp42 - (fTemp43 + fTemp44)));
			float fTemp46 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp45))));
			float fTemp47 = (std::fabs(fTemp46) + -2.0f);
			float fTemp48 = (((fTemp44 + std::min<float>(0.0f, fTemp45)) - (fSlow65 * (1.0f - (((std::fabs((fTemp46 * fTemp47)) + -2.0f) * fTemp46) * fTemp47)))) - fSlow66);
			fVec5[0] = fTemp48;
			fRec13[0] = ((0.900575519f * (fTemp48 + fVec5[1])) - (0.801151097f * fRec13[1]));
			float fTemp49 = ((fSlow81 * fRec13[0]) + (fSlow147 * fRec18[0]));
			fVec6[0] = (fSlow150 * fTemp49);
			fRec36[0] = ((fSlow64 * fVec6[1]) - (fSlow97 * ((fSlow98 * fRec36[1]) - (fSlow152 * fTemp49))));
			fRec38[0] = ((fSlow105 * (std::max<float>(0.0f, (std::max<float>(0.0f, (fRec36[0] - fSlow107)) - fRec38[1])) * std::max<float>(0.0f, (fSlow104 - fRec38[1])))) + (fSlow110 * fRec38[1]));
			fRec37[0] = ((fSlow103 * fRec37[1]) + (fSlow102 * fRec38[0]));
			float fTemp50 = (fSlow59 + ((fRec36[0] - fRec37[0]) - fSlow57));
			float fTemp51 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp50))));
			float fTemp52 = (std::fabs(fTemp51) + -2.0f);
			float fTemp53 = (fSlow50 + ((fSlow55 * (fSlow57 + (std::min<float>(0.0f, fTemp50) - (fSlow59 * (1.0f - ((fTemp51 * (std::fabs((fTemp51 * fTemp52)) + -2.0f)) * fTemp52)))))) - fSlow53));
			float fTemp54 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow54 * std::min<float>(0.0f, fTemp53))));
			float fTemp55 = (fTemp54 * (std::fabs(fTemp54) + -2.0f));
			float fTemp56 = (fSlow50 - (fSlow52 + ((fSlow53 * ((fTemp55 * (std::fabs(fTemp55) + -2.0f)) + 1.0f)) + std::max<float>(0.0f, fTemp53))));
			float fTemp57 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp56))));
			float fTemp58 = (std::fabs(fTemp57) + -2.0f);
			float fTemp59 = ((fSlow51 * (((fTemp57 * (std::fabs((fTemp57 * fTemp58)) + -2.0f)) * fTemp58) + 1.0f)) + std::max<float>(0.0f, fTemp56));
			fRec39[0] = ((fSlow114 * fRec39[1]) + (fSlow115 * (std::max<float>(fSlow118, (fSlow48 + fTemp59)) - fSlow118)));
			float fTemp60 = (fSlow112 * fRec39[0]);
			fRec35[0] = ((fSlow121 * fRec35[1]) + (fSlow44 * (std::max<float>(0.0f, (fSlow43 - fRec35[1])) * std::max<float>(0.0f, ((std::max<float>(fSlow46, (fSlow48 + (fTemp59 - fTemp60))) - fRec35[1]) - fSlow46)))));
			float fTemp61 = (fSlow41 * fRec35[0]);
			float fTemp62 = (fSlow85 + (fTemp59 - (fTemp60 + fTemp61)));
			float fTemp63 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp62))));
			float fTemp64 = (fTemp63 * (std::fabs(fTemp63) + -2.0f));
			float fTemp65 = (((fTemp61 + std::min<float>(0.0f, fTemp62)) - (fSlow65 * (1.0f - (fTemp64 * (std::fabs(fTemp64) + -2.0f))))) - fSlow66);
			fVec7[0] = fTemp65;
			fRec34[0] = ((0.900575519f * (fTemp65 + fVec7[1])) - (0.801151097f * fRec34[1]));
			fVec8[0] = (fSlow3 * fRec34[0]);
			fRec33[0] = ((fSlow124 * fVec8[1]) - (fSlow92 * ((fSlow123 * fRec33[1]) - (fSlow153 * fRec34[0]))));
			fRec41[0] = ((fSlow128 * (std::max<float>(0.0f, (std::max<float>(0.0f, (fRec33[0] - fSlow129)) - fRec41[1])) * std::max<float>(0.0f, (fSlow104 - fRec41[1])))) + (fSlow130 * fRec41[1]));
			fRec40[0] = ((fSlow126 * fRec41[0]) + (fSlow127 * fRec40[1]));
			float fTemp66 = (fSlow59 + ((fRec33[0] - fRec40[0]) - fSlow88));
			float fTemp67 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp66))));
			float fTemp68 = ((std::fabs(fTemp67) + -2.0f) * fTemp67);
			float fTemp69 = (fSlow86 + ((fSlow87 * (fSlow88 + (std::min<float>(0.0f, fTemp66) - (fSlow59 * (1.0f - (fTemp68 * (std::fabs(fTemp68) + -2.0f))))))) - fSlow53));
			float fTemp70 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow54 * std::min<float>(0.0f, fTemp69))));
			float fTemp71 = (std::fabs(fTemp70) + -2.0f);
			float fTemp72 = (fSlow86 - (fSlow52 + ((fSlow53 * ((((std::fabs((fTemp70 * fTemp71)) + -2.0f) * fTemp70) * fTemp71) + 1.0f)) + std::max<float>(0.0f, fTemp69))));
			float fTemp73 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp72))));
			float fTemp74 = (std::fabs(fTemp73) + -2.0f);
			float fTemp75 = (std::max<float>(0.0f, fTemp72) + (fSlow51 * (((fTemp73 * (std::fabs((fTemp73 * fTemp74)) + -2.0f)) * fTemp74) + 1.0f)));
			fRec42[0] = ((fSlow131 * fRec42[1]) + (fSlow132 * (std::max<float>(fSlow133, (fSlow48 + fTemp75)) - fSlow133)));
			float fTemp76 = (fSlow112 * fRec42[0]);
			fRec32[0] = ((fSlow134 * (std::max<float>(0.0f, ((std::max<float>(fSlow135, (fSlow48 + (fTemp75 - fTemp76))) - fRec32[1]) - fSlow135)) * std::max<float>(0.0f, (fSlow43 - fRec32[1])))) - (fSlow154 * fRec32[1]));
			float fTemp77 = (fSlow41 * fRec32[0]);
			float fTemp78 = (fSlow85 + (fTemp75 - (fTemp76 + fTemp77)));
			float fTemp79 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp78))));
			float fTemp80 = (std::fabs(fTemp79) + -2.0f);
			float fTemp81 = (((fTemp77 + std::min<float>(0.0f, fTemp78)) - (fSlow65 * (1.0f - ((fTemp80 * (std::fabs((fTemp80 * fTemp79)) + -2.0f)) * fTemp79)))) - fSlow66);
			fVec9[0] = fTemp81;
			fRec31[0] = ((0.900575519f * (fTemp81 + fVec9[1])) - (0.801151097f * fRec31[1]));
			float fTemp82 = ((fSlow79 * fTemp49) + (fSlow149 * fRec31[0]));
			fVec10[0] = (fSlow77 * fTemp82);
			fRec12[0] = ((fSlow76 * fVec10[1]) - (fSlow138 * ((fSlow139 * fRec12[1]) - (fSlow155 * fTemp82))));
			fRec44[0] = ((fSlow143 * (std::max<float>(0.0f, (fSlow104 - fRec44[1])) * std::max<float>(0.0f, (std::max<float>(0.0f, (fRec12[0] - fSlow129)) - fRec44[1])))) - (fSlow144 * fRec44[1]));
			fRec43[0] = ((fSlow145 * fRec43[1]) + (fSlow142 * fRec44[0]));
			float fTemp83 = (fSlow59 + ((fRec12[0] - fRec43[0]) - fSlow72));
			float fTemp84 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp83))));
			float fTemp85 = (std::fabs(fTemp84) + -2.0f);
			float fTemp86 = (fSlow69 + ((fSlow71 * (fSlow72 + (std::min<float>(0.0f, fTemp83) - (fSlow59 * (1.0f - ((fTemp85 * (std::fabs((fTemp85 * fTemp84)) + -2.0f)) * fTemp84)))))) - fSlow53));
			float fTemp87 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow54 * std::min<float>(0.0f, fTemp86))));
			float fTemp88 = (std::fabs(fTemp87) + -2.0f);
			float fTemp89 = (fSlow69 - (fSlow70 + ((fSlow53 * ((((std::fabs((fTemp88 * fTemp87)) + -2.0f) * fTemp88) * fTemp87) + 1.0f)) + std::max<float>(0.0f, fTemp86))));
			float fTemp90 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp89))));
			float fTemp91 = ((std::fabs(fTemp90) + -2.0f) * fTemp90);
			float fTemp92 = (std::max<float>(0.0f, fTemp89) + (fSlow51 * ((fTemp91 * (std::fabs(fTemp91) + -2.0f)) + 1.0f)));
			fRec45[0] = ((fSlow132 * (fSlow116 + std::max<float>(fSlow117, (fSlow67 + fTemp92)))) + (fSlow131 * fRec45[1]));
			float fTemp93 = (fSlow112 * fRec45[0]);
			fRec46[0] = ((fSlow82 * (std::max<float>(0.0f, ((std::max<float>(fSlow83, (fSlow67 + (fTemp92 - fTemp93))) - fRec46[1]) - fSlow83)) * std::max<float>(0.0f, (fSlow43 - fRec46[1])))) + (fSlow146 * fRec46[1]));
			float fTemp94 = (fSlow41 * fRec46[0]);
			float fTemp95 = (fSlow68 + (fTemp92 - (fTemp93 + fTemp94)));
			float fTemp96 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp95))));
			float fTemp97 = (std::fabs(fTemp96) + -2.0f);
			float fTemp98 = (((std::min<float>(0.0f, fTemp95) + fTemp94) - (fSlow65 * (1.0f - (((std::fabs((fTemp97 * fTemp96)) + -2.0f) * fTemp97) * fTemp96)))) - fSlow66);
			fVec11[0] = fTemp98;
			fRec11[0] = ((0.900575519f * (fTemp98 + fVec11[1])) - (0.801151097f * fRec11[1]));
			fVec12[0] = (fSlow3 * fRec11[0]);
			fRec10[0] = ((fSlow64 * fVec12[1]) - (fSlow97 * ((fSlow98 * fRec10[1]) - (fSlow156 * fRec11[0]))));
			fRec48[0] = ((fSlow105 * (std::max<float>(0.0f, (std::max<float>(0.0f, (fRec10[0] - fSlow107)) - fRec48[1])) * std::max<float>(0.0f, (fSlow104 - fRec48[1])))) - (fSlow157 * fRec48[1]));
			fRec47[0] = ((fSlow103 * fRec47[1]) + (fSlow102 * fRec48[0]));
			float fTemp99 = (fSlow59 + ((fRec10[0] - fRec47[0]) - fSlow57));
			float fTemp100 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow111 * std::max<float>(0.0f, fTemp99))));
			float fTemp101 = ((std::fabs(fTemp100) + -2.0f) * fTemp100);
			float fTemp102 = (fSlow50 + ((fSlow55 * (fSlow57 + (std::min<float>(0.0f, fTemp99) - (fSlow59 * (1.0f - (fTemp101 * (std::fabs(fTemp101) + -2.0f))))))) - fSlow53));
			float fTemp103 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow54 * std::min<float>(0.0f, fTemp102))));
			float fTemp104 = (std::fabs(fTemp103) + -2.0f);
			float fTemp105 = (fSlow50 - (fSlow52 + ((fSlow53 * ((((std::fabs((fTemp103 * fTemp104)) + -2.0f) * fTemp103) * fTemp104) + 1.0f)) + std::max<float>(0.0f, fTemp102))));
			float fTemp106 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow84 * std::min<float>(0.0f, fTemp105))));
			float fTemp107 = (fTemp106 * (std::fabs(fTemp106) + -2.0f));
			float fTemp108 = (std::max<float>(0.0f, fTemp105) + (fSlow51 * ((fTemp107 * (std::fabs(fTemp107) + -2.0f)) + 1.0f)));
			fRec49[0] = ((fSlow115 * (std::max<float>(fSlow118, (fSlow48 + fTemp108)) - fSlow118)) + (fSlow114 * fRec49[1]));
			float fTemp109 = (fSlow112 * fRec49[0]);
			fRec9[0] = ((fSlow44 * (std::max<float>(0.0f, (fSlow43 - fRec9[1])) * std::max<float>(0.0f, ((std::max<float>(fSlow46, (fSlow48 + (fTemp108 - fTemp109))) - fRec9[1]) - fSlow46)))) - (fSlow158 * fRec9[1]));
			float fTemp110 = (fSlow41 * fRec9[0]);
			float fTemp111 = (fSlow85 + (fTemp108 - (fTemp110 + fTemp109)));
			float fTemp112 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow122 * std::max<float>(0.0f, fTemp111))));
			float fTemp113 = (std::fabs(fTemp112) + -2.0f);
			float fTemp114 = (((fTemp110 + std::min<float>(0.0f, fTemp111)) - (fSlow65 * (1.0f - ((fTemp112 * (std::fabs((fTemp112 * fTemp113)) + -2.0f)) * fTemp113)))) - fSlow66);
			fVec13[0] = fTemp114;
			fRec8[0] = ((0.900575519f * (fTemp114 + fVec13[1])) - (0.801151097f * fRec8[1]));
			float fTemp115 = ((fSlow40 * fRec8[0]) + (fSlow159 * fTemp82));
			float fTemp116 = (fSlow3 * fTemp115);
			fVec14[0] = fTemp116;
			fRec7[0] = ((fSlow34 * fVec14[1]) - (fSlow160 * ((fSlow161 * fRec7[1]) - (fSlow162 * fTemp115))));
			fRec50[0] = (0.0f - (fSlow160 * ((fSlow161 * fRec50[1]) - (fTemp116 + fVec14[1]))));
			float fTemp117 = (fRec7[0] + (fSlow163 * fRec50[0]));
			fVec15[0] = fTemp117;
			fRec6[0] = ((fConst12 * fVec15[1]) - (fConst26 * ((fConst27 * fRec6[1]) - (fConst10 * fTemp117))));
			float fTemp118 = (fConst29 * fRec5[1]);
			fRec5[0] = (fRec6[0] - ((fTemp118 + (fRec5[2] * fSlow172)) / fSlow173));
			float fTemp119 = (fConst29 * fRec4[1]);
			fRec4[0] = ((((fRec5[2] * fSlow175) + (fTemp118 + (fRec5[0] * fSlow176))) / fSlow173) - (((fSlow181 * fRec4[2]) + fTemp119) / fSlow182));
			float fTemp120 = ((fRec4[2] * fSlow184) + (fTemp119 + (fRec4[0] * fSlow185)));
			float fTemp121 = (fTemp120 / fSlow182);
			fVec16[0] = fTemp121;
			fRec3[0] = (0.0f - (((fSlow27 * fRec3[1]) - (fTemp121 + fVec16[1])) / fSlow186));
			fRec51[0] = ((fVec16[1] * fSlow187) - (((fSlow27 * fRec51[1]) - (fTemp120 / fSlow188)) / fSlow186));
			float fTemp122 = (fConst35 * fRec2[1]);
			fRec2[0] = ((fRec3[0] + (fRec51[0] * fSlow189)) - ((fTemp122 + (fSlow194 * fRec2[2])) / fSlow195));
			float fTemp123 = ((fSlow22 * (((((fRec2[0] * fSlow197) + fTemp122) + (fSlow198 * fRec2[2])) * fSlow209) / fSlow195)) - fSlow210);
			fVec17[0] = fTemp123;
			fRec1[0] = ((fSlow20 * fVec17[1]) - (fSlow211 * ((fSlow212 * fRec1[1]) - (fSlow18 * fTemp123))));
			fRec52[0] = ((fSlow214 * (fRec1[0] - fSlow215)) + (fSlow213 * fRec52[1]));
			fRec53[0] = ((fSlow218 * (std::max<float>(0.0f, (fSlow217 - fRec53[1])) * std::max<float>(0.0f, (std::max<float>(0.0f, (fSlow219 + ((fRec1[0] - fRec52[0]) - fSlow215))) - fRec53[1])))) + (fSlow220 * fRec53[1]));
			float fTemp124 = ((fRec1[0] - (fRec52[0] + fRec53[0])) - fSlow215);
			float fTemp125 = (fSlow16 * fTemp124);
			fRec54[0] = ((fSlow223 * (fSlow224 + std::max<float>(fSlow225, fTemp125))) + (fSlow222 * fRec54[1]));
			float fTemp126 = (fSlow221 * fRec54[0]);
			fRec55[0] = ((fSlow228 * fRec55[1]) + (fSlow229 * std::min<float>(1.0f, std::fabs((fSlow230 * (fTemp125 - fTemp126))))));
			float fTemp127 = (fSlow226 / ((fSlow227 * fRec55[0]) + 1.0f));
			float fTemp128 = (fSlow15 + (fTemp125 - (fTemp126 + fTemp127)));
			float fTemp129 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow231 * std::max<float>(0.0f, fTemp128))));
			float fTemp130 = (std::fabs(fTemp129) + -2.0f);
			float fTemp131 = (((std::min<float>(0.0f, fTemp128) + fTemp127) - (fSlow15 * (1.0f - ((fTemp130 * (std::fabs((fTemp130 * fTemp129)) + -2.0f)) * fTemp129)))) - fSlow232);
			fRec57[0] = ((fSlow222 * fRec57[1]) + (fSlow223 * (fSlow224 + std::max<float>(fSlow225, (0.0f - fTemp125)))));
			float fTemp132 = (fTemp125 + (fSlow221 * fRec57[0]));
			fRec56[0] = ((fSlow228 * fRec56[1]) + (fSlow229 * std::min<float>(1.0f, std::fabs((fSlow230 * (0.0f - fTemp132))))));
			float fTemp133 = (fSlow226 / ((fSlow227 * fRec56[0]) + 1.0f));
			float fTemp134 = (fSlow15 - (fTemp132 + fTemp133));
			float fTemp135 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow231 * std::max<float>(0.0f, fTemp134))));
			float fTemp136 = (std::fabs(fTemp135) + -2.0f);
			float fTemp137 = (((fTemp133 + std::min<float>(0.0f, fTemp134)) - (fSlow15 * (1.0f - ((fTemp135 * (std::fabs((fTemp135 * fTemp136)) + -2.0f)) * fTemp136)))) - fSlow232);
			float fTemp138 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow233 * std::min<float>(0.0f, fTemp137))));
			float fTemp139 = (std::fabs(fTemp138) + -2.0f);
			float fTemp140 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow233 * std::min<float>(0.0f, fTemp131))));
			float fTemp141 = ((std::fabs(fTemp140) + -2.0f) * fTemp140);
			float fTemp142 = std::fabs((fSlow236 * fTemp124));
			fRec58[0] = ((fSlow235 * std::max<float>(0.0f, ((std::max<float>(1.0f, fTemp142) + (fSlow237 * std::min<float>(1.0f, fTemp142))) + (-1.0f - fRec58[1])))) + (fSlow238 * fRec58[1]));
			fRec0[0] = ((fSlow14 * ((std::max<float>(0.0f, fTemp131) - (std::max<float>(0.0f, fTemp137) + (fSlow232 * ((((fTemp138 * (std::fabs((fTemp138 * fTemp139)) + -2.0f)) * fTemp139) + 1.0f) - ((fTemp141 * (std::fabs(fTemp141) + -2.0f)) + 1.0f))))) / ((fSlow13 * fRec58[0]) + 1.0f))) - (fSlow239 * ((fSlow240 * fRec0[1]) + (fSlow241 * fRec0[2]))));
			float fTemp143 = ((fSlow12 * fRec0[2]) + (fSlow11 * fRec0[0]));
			fRec59[0] = ((fSlow222 * fRec59[1]) + (fSlow223 * (fSlow243 + std::max<float>(fSlow244, std::fabs(fTemp143)))));
			float fTemp144 = (fSlow3 * (fTemp143 + (fSlow242 * fRec59[0])));
			fRec82[0] = (fTemp144 - (fConst142 * ((fConst144 * fRec82[2]) + (fConst145 * fRec82[1]))));
			fRec81[0] = ((fConst142 * ((fConst143 * fRec82[2]) + ((fConst143 * fRec82[0]) + (fConst141 * fRec82[1])))) - (fConst139 * ((fConst145 * fRec81[1]) + (fConst146 * fRec81[2]))));
			float fTemp145 = (((fConst141 * fRec81[1]) + (fConst143 * fRec81[0])) + (fConst143 * fRec81[2]));
			fVec18[0] = fTemp145;
			fRec80[0] = (0.0f - (fConst135 * ((fConst136 * fRec80[1]) - (fConst139 * (fVec18[1] + fTemp145)))));
			fRec79[0] = (fRec80[0] - (fConst132 * ((fConst147 * fRec79[2]) + (fConst148 * fRec79[1]))));
			float fTemp146 = (fRec79[2] + (fRec79[0] + (2.0f * fRec79[1])));
			fVec19[0] = fTemp146;
			fRec78[0] = ((fConst132 * ((fConst134 * fTemp146) + (fConst149 * fVec19[1]))) - (fConst151 * fRec78[1]));
			fRec77[0] = (fRec78[0] - (fConst129 * ((fConst152 * fRec77[2]) + (fConst153 * fRec77[1]))));
			fRec76[0] = ((fConst129 * ((fConst127 * fRec77[2]) + ((fConst127 * fRec77[0]) + (fConst154 * fRec77[1])))) - (fConst128 * ((fConst153 * fRec76[1]) + (fConst155 * fRec76[2]))));
			fRec75[0] = ((fConst128 * ((fConst127 * fRec76[2]) + ((fConst127 * fRec76[0]) + (fConst154 * fRec76[1])))) - (fConst125 * ((fConst156 * fRec75[2]) + (fConst153 * fRec75[1]))));
			fRec86[0] = (0.0f - (fConst157 * ((fConst150 * fRec86[1]) - (fConst132 * (fVec19[1] + fTemp146)))));
			fRec85[0] = (fRec86[0] - (fConst129 * ((fConst153 * fRec85[1]) + (fConst152 * fRec85[2]))));
			fRec84[0] = ((fConst129 * (fRec85[2] + (fRec85[0] + (2.0f * fRec85[1])))) - (fConst128 * ((fConst155 * fRec84[2]) + (fConst153 * fRec84[1]))));
			fRec83[0] = ((fConst128 * (fRec84[2] + (fRec84[0] + (2.0f * fRec84[1])))) - (fConst125 * ((fConst153 * fRec83[1]) + (fConst156 * fRec83[2]))));
			float fTemp147 = (fConst158 * fRec74[1]);
			fRec74[0] = ((fConst125 * ((0.0316227749f * ((fConst127 * fRec75[2]) + ((fConst154 * fRec75[1]) + (fConst127 * fRec75[0])))) + ((fRec83[0] + (2.0f * fRec83[1])) + fRec83[2]))) - (fConst120 * (fTemp147 + (fConst159 * fRec74[2]))));
			float fTemp148 = (fConst162 * fRec73[1]);
			fRec73[0] = ((fConst120 * ((fConst122 * fRec74[2]) + (fTemp147 + (fConst160 * fRec74[0])))) - (fConst113 * ((fConst161 * fRec73[2]) + fTemp148)));
			float fTemp149 = (fConst165 * fRec72[1]);
			fRec72[0] = ((fConst113 * ((fConst115 * fRec73[2]) + (fTemp148 + (fConst163 * fRec73[0])))) - (fConst106 * ((fConst164 * fRec72[2]) + fTemp149)));
			float fTemp150 = (fConst101 * fRec71[1]);
			fRec71[0] = ((fConst106 * (((fConst108 * fRec72[0]) + fTemp149) + (fConst166 * fRec72[2]))) - (fConst100 * ((fConst167 * fRec71[2]) + fTemp150)));
			float fTemp151 = (fConst172 * fRec70[1]);
			fRec70[0] = ((fConst100 * ((fTemp150 + (fConst169 * fRec71[0])) + (fConst170 * fRec71[2]))) - (fConst92 * ((fConst171 * fRec70[2]) + fTemp151)));
			float fTemp152 = (fConst175 * fRec69[1]);
			fRec69[0] = ((fConst92 * ((fConst94 * fRec70[2]) + (fTemp151 + (fConst173 * fRec70[0])))) - (fConst85 * ((fConst174 * fRec69[2]) + fTemp152)));
			float fTemp153 = (fConst178 * fRec68[1]);
			fRec68[0] = ((fConst85 * (((fConst87 * fRec69[0]) + fTemp152) + (fConst176 * fRec69[2]))) - (fConst78 * ((fConst177 * fRec68[2]) + fTemp153)));
			float fTemp154 = (fConst73 * fRec67[1]);
			fRec67[0] = ((fConst78 * (((fConst80 * fRec68[0]) + fTemp153) + (fConst179 * fRec68[2]))) - (fConst72 * ((fConst180 * fRec67[2]) + fTemp154)));
			float fTemp155 = (fConst184 * fRec66[1]);
			fRec66[0] = ((fConst72 * ((fTemp154 + (fConst182 * fRec67[0])) + (fConst183 * fRec67[2]))) - (fConst65 * (fTemp155 + (fConst185 * fRec66[2]))));
			float fTemp156 = (fConst187 * fRec65[1]);
			fRec65[0] = ((fConst65 * ((fConst67 * fRec66[2]) + (fTemp155 + (fConst186 * fRec66[0])))) - (fConst55 * (fTemp156 + (fConst188 * fRec65[2]))));
			float fTemp157 = ((fConst59 * fRec65[2]) + ((fConst189 * fRec65[0]) + fTemp156));
			fVec20[0] = fTemp157;
			fRec64[0] = ((fConst55 * ((fConst57 * fTemp157) + (fConst190 * fVec20[1]))) - (fConst192 * fRec64[1]));
			fRec63[0] = (fRec64[0] - (fConst48 * ((fConst193 * fRec63[2]) + (fConst195 * fRec63[1]))));
			fRec88[0] = (fConst196 * ((fConst55 * (fVec20[1] + fTemp157)) - (fConst191 * fRec88[1])));
			fRec87[0] = (fRec88[0] - (fConst48 * ((fConst193 * fRec87[2]) + (fConst195 * fRec87[1]))));
			float fTemp158 = (fConst45 * fRec62[1]);
			fRec62[0] = ((fConst48 * ((((fConst50 * fRec63[1]) + (fConst194 * fRec63[0])) + (fConst194 * fRec63[2])) + (fSlow253 * (fRec87[2] + (fRec87[0] + (2.0f * fRec87[1])))))) - ((fTemp158 + (fSlow258 * fRec62[2])) / fSlow259));
			float fTemp159 = (fConst199 * fRec61[1]);
			fRec61[0] = ((((fTemp158 + (fRec62[0] * fSlow261)) + (fRec62[2] * fSlow262)) / fSlow259) - (((fRec61[2] * fSlow264) + fTemp159) / fSlow265));
			float fTemp160 = (fConst40 * fRec60[1]);
			fRec60[0] = ((((fSlow251 * fRec61[2]) + ((fRec61[0] * fSlow266) + fTemp159)) / fSlow265) - ((fTemp160 + (fSlow271 * fRec60[2])) / fSlow272));
			output0[i] = FAUSTFLOAT((fSlow0 * ((iSlow1?(fSlow246 * (((fTemp160 + (fRec60[0] * fSlow274)) + (fRec60[2] * fSlow275)) / fSlow272)):fTemp144) * fSlow286)));
			fVec0[1] = fVec0[0];
			fRec20[1] = fRec20[0];
			fRec22[1] = fRec22[0];
			fRec21[1] = fRec21[0];
