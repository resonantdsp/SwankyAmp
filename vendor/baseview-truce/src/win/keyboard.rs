...
impl KeyboardState {
    ...
    pub(crate) fn get_modifiers(&self) -> Modifiers {
        unsafe {
            ...
            if self.has_altgr && GetKeyState(VK_RMENU.into()) as u16 & 0x8000 != 0 {
